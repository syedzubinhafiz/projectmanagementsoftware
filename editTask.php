...
<form action="updateTask.php" method="post" style="width: 100%; display: contents;">
...
<form action="deleteTask.php" method="post" onsubmit="return confirm('Are you sure you want to delete task?')">
